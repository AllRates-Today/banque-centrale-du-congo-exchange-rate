'use strict';
// Banque Centrale du Congo exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bcc';
...
/** Latest rate for one pair, e.g. getRate('USD', 'CDF', { apiKey }). */
